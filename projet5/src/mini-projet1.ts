...
const stock$ = new BehaviorSubject<number>(100);

const commandes$ = new Subject<number>();

const stockRestant$ = commandes$.pipe(
    scan((stock, commande) => stock - commande, stock$.value)
);

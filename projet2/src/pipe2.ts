...
const searchSimulation$ = from(['a', 'ab', 'abc', 'abcd', 'abcde', 'abcdef', 'abcdefg', 'abcdefgh', 'abcdefghi', 'abcdefghij', 'abcdefghijk', 'abcdefghijkl', 'abcdefghijklm', 'abcdefghijklmn', 'abcdefghijklmno', 'abcdefghijklmnop', 'abcdefghijklmnopq', 'abcdefghijklmnopqr', 'abcdefghijklmnopqrs', 'abcdefghijklmnopqrst', 'abcdefghijklmnopqrstu', 'abcdefghijklmnopqrstuv', 'abcdefghijklmnopqrstuvw', 'abcdefghijklmnopqrstuvwx', 'abcdefghijklmnopqrstuvwxy', 'abcdefghijklmnopqrstuvwxyz']).pipe(
    concatMap((term, index) => 
        of(term).pipe(delay(index * 50)) // Délai croissant pour chaque terme
    )
)
.pipe(
    tap(term => console.log('avant debounce tap : ', term)),
    debounceTime(5000),
    tap(term => console.log('apres debounce tap : ', term)),
    distinctUntilChanged(),
    tap(term => console.log('Recherche en cours : ', term)),

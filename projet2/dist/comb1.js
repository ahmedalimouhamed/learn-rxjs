...
concat(first$, second$).subscribe(value => console.log('cocat : ', value));
...
combineLatest([temperature$, humidity$]).subscribe(([temp, hum]) => console.log(`combineLatest : ${temp}°C, ${hum}%`));

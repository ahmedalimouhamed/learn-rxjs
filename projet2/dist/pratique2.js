...
class NotificationSystem {
    ...
    getNotifications() {
        return this.notification$.pipe(throttleTime(1000), scan((notifications, newNotification) => [...notifications, newNotification].slice(-5), []), distinctUntilChanged());
    }
    getErrorNotifications() {
        return this.notification$.pipe(filter(notification => notification.type === 'error'), map(notification => ({
            ...notification,
            timestamp: new Date()
        })));
    }
...
//# sourceMappingURL=pratique2.js.map